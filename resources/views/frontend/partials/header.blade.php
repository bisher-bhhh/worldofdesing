...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/frontend/owl.carousel/assets/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/frontend/owl.carousel/assets/owl.theme.default.min.css')}}">
