			...
			<div class="row">
				<div class="col-md-12 align-self-center p-static order-2 text-center">
					<div class="overflow-hidden pb-2">
						<h2 class="text-dark font-weight-bold text-7 mb-0">{{$data->title}}</h2>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row pb-4 mb-2">
		<div class="col-sm-6">
			...
			<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
				<img src="{{ asset('assets/uploads/works/work-large-' . $data->id . '.' . $data->image) }}" class="img-fluid border-radius-0" alt="">
			</div>
		...
		<div class="col-sm-6">
			...
			<ul class="list list-icons list-primary list-borders text-2">
				<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Client:</strong> {{$data->clients}}</li>
				<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Date:</strong> {{$data->start_date}}</li>
				<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Category:</strong> <a href="#" class="badge badge-dark badge-sm rounded-pill px-2 py-1 ms-1">{{ get_work_category_by_id($data->id, 'slug') }}</a></li>
