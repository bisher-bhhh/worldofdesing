...
<div class="body">
@yield('content')
{{--@include('frontend.home-pages.home_world')--}}
...
{{--                                <a href="index.html">--}}
{{--                                    <img alt="Porto" width="180" height="180" style="padding-top: 5px"--}}
...
{{--                                                   data-hash-offset-lg="68" href="#services">Services</a>--}}
{{--                                            </li>--}}
{{--                                            <li>--}}
{{--                                                <a class="nav-link" data-hash data-hash-offset="0"--}}
{{--                                                   data-hash-offset-lg="68" href="#projects">Projects</a>--}}
{{--                                            </li>--}}
{{--                                            <li>--}}
{{--                                                <a class="nav-link" data-hash data-hash-offset="0"--}}
{{--                                                   data-hash-offset-lg="68" href="#clients">Clients</a>--}}
{{--                                            </li>--}}
{{--                                            <li>--}}
{{--                                                <a class="nav-link" data-hash data-hash-offset="0"--}}
{{--                                                   data-hash-offset-lg="68" href="#team">Meet the Team</a>--}}
{{--                                            </li>--}}
{{--                                            <li>--}}
{{--                                                <a class="nav-link" data-hash data-hash-offset="0"--}}
{{--                                                   data-hash-offset-lg="68" href="#contact">Contact Us</a>--}}
{{--                                            </li>--}}
{{--                                        </ul>--}}
{{--                                    </nav>--}}
{{--                                </div>--}}
...
{{--                            <div class="portfolio-item">--}}
{{--                                <a href="{{route('frontend.projects')}}" data-ajax-on-modal>--}}
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<span class="owl-carousel owl-theme dots-inside m-0"--}}
{{--                                                          data-plugin-options="{'items': 1, 'margin': 20, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 3000}"><span>--}}
{{--                                                            <img src="{{asset('assets/frontend/img/projects/project-1.jpg')}}"--}}
{{--                                                                 class="img-fluid border-radius-0" alt=""></span>--}}
{{--                                                        <span>--}}
{{--                                                            <img src="{{asset('assets/frontend/img/projects/project-1-2.jpg')}}"--}}
{{--                                                                 class="img-fluid border-radius-0" alt="">--}}
{{--                                                        </span>--}}
{{--                                                    </span>--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-2.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-27.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-4.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-5.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-6.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-7.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-23.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-24.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-25.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--											<span class="thumb-info thumb-info-lighten">--}}
{{--												<span class="thumb-info-wrapper">--}}
{{--													<img src="{{asset('assets/frontend/img/projects/project-26.jpg')}}"--}}
{{--                                                         class="img-fluid border-radius-0" alt="">--}}
{{--													<span class="thumb-info-title">--}}
...
{{--                 style="background-image: url({{asset('assets/frontend/img/bg-one-page-1-1.jpg')}}); background-size: cover; background-position: center;">--}}
{{--            <div class="container">--}}
{{--                <div class="row">--}}
...
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-1.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-2.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-3.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-4.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-5.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-6.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <img class="img-fluid" src="{{asset('assets/frontend/img/logos/logo-light-4.png')}}" alt="">--}}
{{--                        </div>--}}
...
{{--<!-- Examples -->--}}
{{--<script src="{{asset('assets/frontend/js/examples.portfolio.js')}}"></script>--}}
