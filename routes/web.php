...
Route::group(['middleware' => ['setlang','globalVariable']],function (){
    ...
    Route::get('/servicess','FrontendController@getServicesProjects')->name('frontend.services');
    Route::get('/contactus','FrontendController@getContactUs')->name('frontend.contactus');
    Route::get('/portfolioproject','FrontendController@getportfolioproject')->name('frontend.portfolioproject');
    ...
    Route::get('/project','FrontendController@get_project')->name('frontend.project');
    Route::get('/singleproject','FrontendController@getSingleProject')->name('frontend.singleproject');

    Route::get('/load-more-projects', 'FrontendController@loadMoreProjects')->name('load.more.projects');
    Route::get('/projects/load-more', 'FrontendController@getAllProjects')->name('frontend.projects.load_more');
    //language change
...
Route::prefix('admin-home')->group(function (){
    ...
    Route::get('/admin/work/{id}', 'WorksController@showimages')->name('admin.work.show');

    Route::get('/admin/work/{work_id}/images/{image_id}/edit', 'WorksController@editImage')->name('admin.work.image.edit');
    Route::put('/admin/work/{work_id}/images/{image_id}',  'WorksController@updateImage')->name('admin.work.image.update');
    Route::delete('/admin/work/{work_id}/images/{image_id}', 'WorksController@deleteImage')->name('admin.work.image.delete');
