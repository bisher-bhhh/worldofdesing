                ...
                <div class="row portfolio-list lightbox" data-plugin-options="{'delegate': 'a.lightbox-portfolio', 'type': 'image', 'gallery': {'enabled': true}}">
                        ...
                        <div class="portfolio-item">
										<span class="thumb-info thumb-info-lighten thumb-info-centered-icons border-radius-0">
											<span class="thumb-info-wrapper border-radius-0">
												<img src="<?php echo e(asset('assets/frontend/img/projects/project-1.jpg')); ?>" class="img-fluid border-radius-0" alt="">
												<span class="thumb-info-action">
													<a href="<?php echo e(asset('assets/frontend/img/projects/project-1.jpg')); ?>" class="lightbox-portfolio">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="600">
                        <div class="portfolio-item">
										<span class="thumb-info thumb-info-lighten thumb-info-centered-icons border-radius-0">
											<span class="thumb-info-wrapper border-radius-0">
												<img src="<?php echo e(asset('assets/frontend/img/projects/project-25.jpg')); ?>" class="img-fluid border-radius-0" alt="">
												<span class="thumb-info-action">
													<a href="<?php echo e(asset('assets/frontend/img/projects/project-25.jpg')); ?>" class="lightbox-portfolio">
														<span class="thumb-info-action-icon thumb-info-action-icon-light"><i class="fas fa-search text-dark"></i></span>
													</a>
												</span>
											</span>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 appear-animation" data-appear-animation="expandIn">
                        <div class="portfolio-item">
										<span class="thumb-info thumb-info-lighten thumb-info-centered-icons border-radius-0">
											<span class="thumb-info-wrapper border-radius-0">
												<img src="<?php echo e(asset('assets/frontend/img/projects/project-3.jpg')); ?>" class="img-fluid border-radius-0" alt="">
												<span class="thumb-info-action">
													<a href="<?php echo e(asset('assets/frontend/img/projects/project-3.jpg')); ?>" class="lightbox-portfolio">
														<span class="thumb-info-action-icon thumb-info-action-icon-light"><i class="fas fa-search text-dark"></i></span>
													</a>
												</span>
											</span>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="400">
                        <div class="portfolio-item">
										<span class="thumb-info thumb-info-lighten thumb-info-centered-icons border-radius-0">
											<span class="thumb-info-wrapper border-radius-0">
												<img src="<?php echo e(asset('assets/frontend/img/projects/project-1-2.jpg')); ?>" class="img-fluid border-radius-0" alt="">
												<span class="thumb-info-action">
													<a href="<?php echo e(asset('assets/frontend/img/projects/project-1-2.jpg')); ?>" class="lightbox-portfolio">
														<span class="thumb-info-action-icon thumb-info-action-icon-light"><i class="fas fa-search text-dark"></i></span>
													</a>
												</span>
											</span>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\testbasel\pr\resources\views/frontend/projects_test.blade.php ENDPATH**/ ?>