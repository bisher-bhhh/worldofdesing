                        ...
                        <form action="<?php echo e(route('admin.new.user')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <ul class="text-danger">
                                    <li><?php echo e('Editors ( Have all access except Admin Role Manage/Language/Menu/Page )'); ?></li>
                                    <li><?php echo e('Admin ( Have all access except Admin Role Manage/language/general settings )'); ?></li>
                                    <li><?php echo e('Super_Admin ( have everything access )'); ?></li>
                                </ul>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\testbasel\testbasel\pr\resources\views/backend/user-role-manage/add-new-user.blade.php ENDPATH**/ ?>