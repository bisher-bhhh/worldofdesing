                                            ...
                                            <?php $__currentLoopData = $work; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if(file_exists('assets/uploads/works/work-grid-' . $data->id . '.' . $data->image)): ?>
                                                            <img style="max-width: 100px"
                                                                src="<?php echo e(asset('assets/uploads/works/work-grid-' . $data->id . '.' . $data->image)); ?>"
                                                                alt="<?php echo e($data->title); ?>">
                                                            <?php $img_url = asset('assets/uploads/works/work-grid-'.$data->id.'.'.$data->image);?>
                                                        <?php else: ?>
                                                            <img style="max-width: 100px"
                                                                src="<?php echo e(asset('assets/uploads/no-image.png')); ?>"
                                               ...
                                               <br>
                                                ...
                                                ">
                                                        ...
                                                        <a href="<?php echo e(route('admin.work.show',['id'=>$data->id])); ?>"
                                                            class="btn btn-lg btn-danger btn-sm mb-3 mr-1">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                        ...
                        <form action="<?php echo e(route('admin.work')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="clients" name="clients"
                                    placeholder="<?php echo e(__('Clients')); ?>">
                            </div>
                            <div class="form-group">
    ...
    <div class="modal fade" id="work_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.work.update')); ?>" id="works_edit_modal_form" enctype="multipart/form-data"
                    method="post">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            var selected = $.inArray(value.id.toString(), allCat) != -
                                1 ? 'selected' : '';
                            $('#edit_category').append('<option ' + selected +
            ...
            $(document).on('change', '#edit_language', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#edit_category').html('');
                        $.each(data, function(index, value) {
                            $('#edit_category').append('<option value="' + value.id +
                                '">' + value.name + '</option>');
                            $('.nice-select').niceSelect('update');
                        })
                    }
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\testbasel\testbasel\pr\resources\views/backend/pages/works/index.blade.php ENDPATH**/ ?>